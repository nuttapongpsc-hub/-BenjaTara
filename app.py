...
if submit_btn:
    if len(selected_positions) != 3:
        ...
        with st.spinner("🧠 ระบบกำลังสับไพ่ คำนวณลัคนา และสังเคราะห์ข้อมูลมิติซ้อน..."):
            try:
                # --- ลอจิกการสับไพ่ (Shuffle) และดึงไพ่ที่เลือก ---
                ...
                selected_tarot_cards = [shuffled_deck[i] for i in selected_indices]
                # ----------------------------------------------------
